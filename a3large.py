...
files = [
    {'filename': 'olist_customers_dataset.csv', 'table': 'Customers', 'columns': {'customer_id': 0, 'customer_postal_code': 2}, 'rename_columns': {'customer_zip_code_prefix': 'customer_postal_code'}, 'row_count': 33000},
    {'filename': 'olist_sellers_dataset.csv', 'table': 'Sellers', 'columns': {'seller_id': 0, 'seller_postal_code': 1}, 'row_count': 1000},
    {'filename': 'olist_orders_dataset.csv', 'table': 'Orders', 'columns': {'order_id': 0, 'customer_id': 1}, 'row_count': 33000},
    {'filename': 'olist_order_items_dataset.csv', 'table': 'Order_items', 'columns': {'order_id': 0, 'order_item_id': 1, 'product_id': 2, 'seller_id': 3}, 'row_count': 10000}
]
